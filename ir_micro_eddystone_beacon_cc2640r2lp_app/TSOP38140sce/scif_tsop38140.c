...
static const uint16_t pAuxRamImage[] = {
    ...
    /*0x00C0*/ 0x6436, 0xBDB7, 0x241A, 0xA6FE, 0xADB7, 0x641A, 0xADB7, 0x0000, 0x0098, 0x00A0, 0x013A, 0x0000, 0x0000, 0xFFFF, 0x0000, 0x0000, 
    /*0x00E0*/ 0x0000, 0x0000, 0x0000, 0x0000, 0x0000, 0x0960, 0x003C, 0x0004, 0x0009, 0x0001, 0x0000, 0x0960, 0x0000, 0x003C, 0x0000, 0x0001, 
    /*0x0100*/ 0x0001, 0x0001, 0x0001, 0x0001, 0x0001, 0x0001, 0x0001, 0x0001, 0x0001, 0x0001, 0x0001, 0x0001, 0x0001, 0x0001, 0x0001, 0x0001, 
    /*0x0120*/ 0x0001, 0x0001, 0x0001, 0x0001, 0x0001, 0x0001, 0x0000, 0x0000, 0x7878, 0x6000, 0x153B, 0x7878, 0x154A, 0x0001, 0x0C67, 0xADB7, 
    /*0x0140*/ 0x087E, 0x8A00, 0xB601, 0x0534, 0x7877, 0x1552, 0x701D, 0x6007, 0x155A, 0x0000, 0x0C97, 0x0000, 0x8A0A, 0xA635, 0x8A06, 0xA60C, 
    /*0x0160*/ 0x5001, 0x660F, 0x1005, 0x8500, 0xFD47, 0x460F, 0x111F, 0x8500, 0xFD47, 0xD8FF, 0xBEF6, 0x04C2, 0x112C, 0x9B0C, 0x1000, 0x9B09, 
    /*0x0180*/ 0x640B, 0xCDB1, 0x5003, 0x1560, 0x107F, 0xFF39, 0x107F, 0x9F19, 0x9A00, 0xBE08, 0x0C96, 0x1001, 0x1C7A, 0x1879, 0x9A01, 0xBE01, 
    /*0x01A0*/ 0x0017, 0x04DB, 0x88FF, 0x107F, 0x9F19, 0x9A00, 0xBE03, 0x9D40, 0x9801, 0x1C97, 0x8801, 0x112C, 0x9B0C, 0x1000, 0x9B09, 0x640B, 
    /*0x01C0*/ 0xCDB1, 0x8801, 0x04AC, 0x7877, 0x154A, 0x8A0A, 0xBE04, 0x0000, 0x0C96, 0x0000, 0x0C7A, 0x087A, 0x8A01, 0xBE0E, 0x087C, 0x8A00, 
    /*0x01E0*/ 0xBE07, 0x0005, 0x0C76, 0x0876, 0x0C7D, 0x0001, 0x0C7E, 0x04FB, 0x087D, 0x88FF, 0x0C7D, 0x0509, 0x087C, 0x8A01, 0xBE07, 0x003C, 
    /*0x0200*/ 0x0C76, 0x0876, 0x0C7D, 0x0001, 0x0C7E, 0x0509, 0x087D, 0x88FF, 0x0C7D, 0x087A, 0x0C7C, 0x087D, 0x8A00, 0xBE04, 0x0876, 0x0C7D, 
    /*0x0220*/ 0x0001, 0x0C7E, 0x087B, 0x1875, 0x8D29, 0xBE02, 0x0001, 0x0C7E, 0x087E, 0x8A01, 0xBE05, 0x0000, 0x0C7E, 0x086C, 0x8201, 0x0C6C, 
    /*0x0240*/ 0x087A, 0x8A01, 0xBE11, 0x860F, 0x03A0, 0x8B0C, 0x0001, 0x8B09, 0x640B, 0x0000, 0x7878, 0x1552, 0xCDB1, 0x7878, 0x154A, 0xCDB1, 
    /*0x0260*/ 0x8801, 0x8A64, 0xAEF7, 0x440B, 0x087B, 0x8801, 0x0C7B, 0x0001, 0x0C67, 0xADB7, 0xADB7, 0xDD47, 0xDDAB, 0xD810, 0xF007, 0xED87, 
    /*0x0280*/ 0xED87, 0x4003, 0xCD87, 0xCD87, 0xCD92, 0xFF05, 0xFD04, 0xFD0E, 0xFF25, 0xADB7, 0xED47, 0xEDAB, 0xE816, 0xF007, 0x5001, 0xDD87, 
    /*0x02A0*/ 0xDF26, 0xADB7, 0xED47, 0xEDAB, 0xE814, 0xF007, 0x5001, 0xDD87, 0xDF26, 0xADB7, 0xFB0C, 0xEDA4, 0xEB09, 0x640B, 0xCDB1, 0xADB7, 
    /*0x02C0*/ 0xE913, 0xEDA0, 0xF912, 0xFD0E, 0xFD8D, 0xF001, 0xADB7
};
...
//  cfg         input       output      state       
    0x005010EA, 0x00000000, 0x001010F4, 0x01D010F6  // IRLED
};
...
static void scifTaskResourceInit(void) {
    ...
    scifInitIo(4, AUXIOMODE_OPEN_SOURCE, -1, 0);
    scifInitIo(9, AUXIOMODE_OPEN_SOURCE, -1, 0);
    scifInitIo(10, AUXIOMODE_OUTPUT, -1, 0);

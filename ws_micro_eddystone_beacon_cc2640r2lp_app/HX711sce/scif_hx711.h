/** \mainpage Driver Overview
  ...
  * - <b>Project file</b>:     C:/ti/workspace_v7/ws_micro_eddystone_beacon_cc2640r2lp_app/HX711sce/HX711.scp
  ...
  * - <b>Created</b>:          2017-12-17 19:56:33.880
...
/// ADC24bit: 
#define SCIF_HX711_ADC24BIT_BUFFER_SIZE 16
...
typedef struct {
    ...
    int16_t  adcVal;       ///< 
    uint16_t buzz;         ///< 
    uint16_t pSamples[16]; ///< buffer for ADC samples

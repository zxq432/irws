 ...
 */
xdc__META(__ASM__, "@(#)__ASM__ = C:/ti/workspace_v7/beacon_rfdriver_cc2640r2rsm/Debug/configPkg/package/cfg/rom_pem3");
...
__FAR__ const CT__ti_sysbios_hal_Hwi_Module__id ti_sysbios_hal_Hwi_Module__id__C = (xdc_Bits16)0x2e;
...
__FAR__ const CT__ti_sysbios_rom_cortexm_cc26xx_r2_CC26xx_Module__id ti_sysbios_rom_cortexm_cc26xx_r2_CC26xx_Module__id__C = (xdc_Bits16)0x30;
...
xdc_Ptr ti_sysbios_heaps_HeapNull_Object__get__S(xdc_Ptr oa, xdc_Int i)
{
    ...
    return ((ti_sysbios_heaps_HeapNull_Object__ * const)ti_sysbios_heaps_HeapNull_Object__table__C) + i;
}
    ...
    xdc_runtime_Error_Block *__eb)
{
    ...
    __obj = xdc_runtime_Core_createObject__I(&ti_sysbios_heaps_HeapNull_Object__DESC__C, NULL, &__prms, (xdc_CPtr)__paramsPtr, 0, __eb);
    if (__obj == NULL) {
        return NULL;
    }
...
/* create */
ti_sysbios_heaps_HeapNull_Handle ti_sysbios_heaps_HeapNull_create( const ti_sysbios_heaps_HeapNull_Params *__paramsPtr, xdc_runtime_Error_Block *__eb )
{
    ti_sysbios_heaps_HeapNull_Params __prms;
    ti_sysbios_heaps_HeapNull_Object *__obj;
